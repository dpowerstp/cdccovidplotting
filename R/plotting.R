...
#' @param countydf CDC community-level dataframe filtered to one county
#' @param .covidvar Data-masked name of variable associated with covid-cases per 100,000 residents; default covid_cases_per_100k
#' @param .countycol Data-masked name of variable associated with filtered county; default county
#'
...
#'
#' @param countydf CDC community-level dataframe filtered to one county. Alternatively, can provide unfiltered dataframe with countyfilt set to county want to filter data to
#' @param varevals Expression of variables plotting in y-axis. E.g., ~ covid_cases_per_100k. Default c(~ covid_cases_per_100k, ~ covid_hospital_admissions_per_100k, ~ covid_hospital_admissions_per_100k)
